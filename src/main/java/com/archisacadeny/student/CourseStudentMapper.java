...
public class CourseStudentMapper {
    ...
    //REMOVE STATIC
    public static void saveToCourseStudentMapper(int studentID, int courseId, double grade, Timestamp start, Timestamp end, int attendedLessons ){
        String query = "INSERT INTO course_student_mapper(student_id,course_id,grade,course_start_date,course_end_date,attended_lessons) VALUES(?,?,?,?,?,?)";
